...
vim.keymap.set('n', '<leader>no', '<cdm>lua require("custom_fzf_lua").openFile()<CR>', {desc = 'find and open note through telescope'})
...
vim.keymap.set('n', '<leader>nb', '<cmd>lua require("custom_telescope").backlinksSearch()<cr>', {desc = 'find backlinks to open note'})
...
vim.keymap.set('n', '<leader>nl', '<cmd>lua require("custom_telescope").listOfNotes()<CR>', {desc = 'list all notes in reverse order'})
