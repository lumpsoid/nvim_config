...
-- notes
vim.keymap.set('n', '<leader>no', '<cmd>lua require("custom_fzf_lua").openFile()<CR>', {desc = 'find and open note through telescope'})
vim.keymap.set({'i', 'n'}, '<C-k>', '<cmd>lua require("custom_fzf_lua").insertId()<CR>', {desc = 'for any note [[ID]] insert'})
vim.keymap.set({'i', 'n'}, '<C-q>', '<cmd>lua require("custom_fzf_lua").insertHeadId()<CR>', {desc = 'tree note [[ID]] insert'})
vim.keymap.set('n', '<leader>nb', '<cmd>lua require("custom_fzf_lua").backlinks()<cr>', {desc = 'find backlinks to open note'})
...
vim.keymap.set('n', '<leader>na', '<esc>:lua require("custom_fzf_lua").findAroundNote()<cr>', {desc = 'view notes which was created in the same date as current note'})
vim.keymap.set('n', '<Leader>nd', '<cmd>lua require("custom_functions").delCurrentFile()<CR>', {desc = 'delete current file'})
vim.keymap.set('n', '<Leader>nc', '<cmd>lua require("custom_functions").currentLink()<CR>', {desc = 'copy link to current file'})
vim.keymap.set('n', '<leader>nl', '<cmd>lua require("custom_fzf_lua").listOfNotes()<CR>', {desc = 'list all notes in reverse order'})
